...
const experiences = [
  {
    ...
    impact: [
      "Collaborated with engineering and SRE teams to reduce MTTR by 15%, improving customer reliability benchmarks",
      "Authored internal runbooks covering cluster tuning, monitoring baselines, schema optimization, and diagnostics",
      "Led cloud architecture training sessions enabling 20+ engineers to troubleshoot distributed DB clusters confidently",
    ],
  ...
  },
  {
    ...
    impact: [
      "Supported 50+ global customers in 24×7 operations, handling escalations, outage communication, and SLAs",
      "Authored 25+ internal KB articles reducing repetitive issue patterns by 30% and improving onboarding efficiency",
      "Reduced resolution time by 20% via structured RCA, engine log diagnostics, and automated health checks",
    ],
